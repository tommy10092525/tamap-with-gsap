  ...
  return (
    <div className='bg-zinc-100 dark:bg-zinc-950 text-black dark:text-white min-h-screen'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-8 mt-16'>
        <Link href="/discount/fuji" className='bg-gray-100 dark:bg-zinc-900 border-0 dark:border dark:border-zinc-700 rounded-lg shadow-lg hover:scale-105 transition-all duration-300'>
        ...
        <Link href="/discount/hicheese" className='bg-gray-100 dark:bg-zinc-900 border-0 dark:border dark:border-zinc-700 rounded-lg shadow-lg hover:scale-105 transition-all duration-300'>
        ...
        <Link href="/discount/goemon" className='bg-gray-100 dark:bg-zinc-900 border-0 dark:border dark:border-zinc-700 rounded-lg shadow-lg hover:scale-105 transition-all duration-300'>
        ...
        <Link href="/discount/kokuterudou" className='bg-gray-100 dark:bg-zinc-900 border-0 dark:border dark:border-zinc-700 rounded-lg shadow-lg hover:scale-105 transition-all duration-300'>
