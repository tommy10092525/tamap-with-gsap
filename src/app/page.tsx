      ...
      <div className="bg-gradient-to-bl from-sky-400 dark:from-blue-500 to-orange-400 dark:to-orange-400 p-3 md:p-7 w-full h-full min-h-screen text-black dark:text-white">
        ...
        <div className="gap-3 md:grid md:grid-cols-5 mx-auto p-3 max-w-5xl touch-manipulation" ref={mainContainer}>
          ...
          <div className="relative col-span-3 bg-white/20 dark:bg-black/30 shadow-lg mt-4 js-map-container rounded-2xl w-full h-auto font-semibold text-lg hoverable:hover:scale-110" ref={overlayContainer}>
            ...
            <div className="top-4 left-4 absolute bg-zinc-300/90 dark:bg-zinc-800/90 shadow-lg backdrop-blur-sm p-2 rounded-lg w-1/4 max-sm:w-1/3 h-16 overflow-hidden text-center transform-gpu will-change-auto">
              経済
              <span className="block" ref={times.economics}>{overlay.economics}</span>
            </div>
            <div className="top-4 right-4 absolute bg-zinc-300/90 dark:bg-zinc-800/90 shadow-lg backdrop-blur-sm p-2 rounded-lg w-1/4 max-sm:w-1/3 h-16 overflow-hidden text-center transform-gpu will-change-auto">
              社・現福
              <span className="block" ref={times.health}>{overlay.health}</span>
            </div>
            <div className="bottom-4 left-4 absolute bg-zinc-300/90 dark:bg-zinc-800/90 shadow-lg backdrop-blur-sm p-2 rounded-lg w-1/4 max-sm:w-1/3 h-16 overflow-hidden text-center transform-gpu will-change-auto">
              体育館
              <span className="block" ref={times.gym}>{overlay.gym}</span>
            </div>
            <div className="right-4 bottom-4 absolute bg-zinc-300/90 dark:bg-zinc-800/90 shadow-lg backdrop-blur-sm p-2 rounded-lg w-1/4 max-sm:w-1/3 h-16 overflow-hidden text-center transform-gpu will-change-auto">
              スポ健康
