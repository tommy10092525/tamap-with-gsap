...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-bl from-sky-400 dark:from-blue-500 to-orange-400 dark:to-orange-400 bg-fixed p-3 md:p-7 w-full h-full min-h-screen text-black dark:text-white">
